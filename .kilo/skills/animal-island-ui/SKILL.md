...
> **本地源码参考**：本 skill 目录下随附 `AI_USAGE.md`（API 速查）与 `DESIGN_PROMPT.md`（设计提示词包）两份文档，编程时可一并参考。
> 上游完整仓库（含 `src/components/...`、`demo/`、`test/` 等源码）位于 GitHub：https://github.com/guokaigdg/animal-island-ui ，需要查阅源码细节时请前往该仓库。
